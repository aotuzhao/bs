package com.magpie.bbs.forum.es.config;
...
import com.magpie.bbs.forum.es.vo.EsIndexTypeData;
import com.magpie.bbs.forum.util.EsUtil;
...
public class AOPConfig {
	...
	@Pointcut("@annotation(com.magpie.bbs.forum.es.annotation.EsIndexType) || @annotation(com.magpie.bbs.forum.es.annotation.EsIndexs)")
